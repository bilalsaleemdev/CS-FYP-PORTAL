...
import { getEmployeeUserAPI } from "../../../api/network/customer/EmployeeApi";
...
const Projects = (props) => {
  ...
  useEffect(() => {
    getData();
    setUserProjectList(project.employee);
  }, [project]);
  useEffect(() => {
  ...
  }, [project, userProjectList, employeelUser]);
  ...
  const getData = () => {
    console.log('aaaaaaaaaaaaaaaaa',props?.history?.location?.personNAme)
                ...
                <div className="project-title">
                  ...
                  <small className="block text-ellipsis m-b-15">
                    <span className="text-xs">
                      {
                        project?.task?.filter((x) => x.task_status === 0)
                          ?.length
                      }{" "}
                    </span>{" "}
                    ...
                    <span className="text-xs">
                      {" "}
                      {
                        project?.task?.filter((x) => x.task_status === 1)
                          ?.length
                      }
                    </span>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="text-right">
                        {" "}
                        {moment(project?.project?.created_at).format(
                          "DD MM YYYY"
                        )}
                      </td>
                    </tr>
                    <tr>
                      <td>Deadline:</td>
                      <td className="text-right">
                        {moment(project?.project?.end_at).format("DD MM YYYY")}
                      </td>
                    </tr>
