 ...
 */
 ...
 import {getAllTaskEmployee} from "../../../../../api/network/customer/EmployeeApi";
 ...
 const employeeTasks = () => {
  ...
  const cancelTokenSource = axios.CancelToken.source();
    ...
    const getAllTaskOFEmployee = async (id) => {
      let totalTasks = [];
      const response = await getAllTaskEmployee(EmployeeId ,cancelTokenSource.token);

      if (response.success == true) {
        console.log("12121212");
    
        setTaskData(response.data.total_task);
        // console.log(taskData, "awais data for all task");
      }
      // console.log(taskData, "awais data for all task");
    };
...
//  class employeeTasks extends React.Component {
//      constructor(props) {
//          super(props);
//          this.state = {
//             data : [
