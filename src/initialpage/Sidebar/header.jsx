                        ...
                        <div className="media">
                          ...
                          <div className="media-body">
                            <p className="noti-details">
                              <span className="noti-title">Name</span>{" "}
                              {item.employ_name}
                            </p>
                            {/* <p className="noti-time"><span className="notification-time">Days {item.day}</span></p> */}
                            <p className="noti-details">
                              <span
                                onClick={(e) => notificationCancle(item, e)}
                                className="noti-title"
                              >
                                Email {item.employ_email}
                              </span>
                            </p>
                          </div>
                        </div>
                  ...
                  <div className="noti-content">
                    <ul className="notification-list">
                      {conferenceNotification &&
                        conferenceNotification.map((item) => (
                          <li className="notification-message" key={item.id}>
                            <a>
                              <div className="media">
                                {/* <span className="avatar">
                          ...
                          <img alt="" src={Avatar_02} />
                                ...
                                <div className="media-body">
                                  ...
                                  <p className="noti-details">
                                    <span
                                      onClick={(e) =>
                                        ProjectNotificationCancle(item, e)
                                      }
                                      style={{ color: "salmon" }}
                                    >
                                      Clear Notification
